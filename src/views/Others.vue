...
export default {  
  ...
  mounted: function () {
    ...
    var data = {
      ...
      seriesData: [
        { name: "loan_amnt:35000", value: "20" },
        { name: "term:30 mouths", value: "10" },
        { name: "int_rate:7.99", value: "5" },
        { name: "installment:996.05", value: "5" },
        { name: "grade:C", value: "10" },
        { name: "emp_title:Human Resources", value: "1" },
        { name: "emp_length:5 years", value: "4" },
        { name: "home_ownership:MORTGAGE", value: "5" },
        { name: "annual_inc:35000", value: "5" },
        { name: "verification_status:Not Verified", value: "5" },
        { name: "loan_status:Current", value: "10" },
        { name: "purpose:major_purchase", value: "1" },
        { name: "title:Major purchase", value: "1" },
        { name: "earliest_cr_line:Dec-2016", value: "1" },
        { name: "open_acc:12", value: "1" },
